...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({super.key, required this.sorting, required this.title});
              ...
              return RefreshIndicator(
                ...
                child: MasonryGridView.count(
                  ...
                  padding: EdgeInsets.only(
                    ...
                    right: 8,
                    top:
                        8 + kToolbarHeight + MediaQuery.of(context).padding.top,
                    bottom: 100, // Extra padding for floating nav bar
                  ),
                  itemCount:
                      provider.wallpapers.length + (provider.hasMore ? 1 : 0),
