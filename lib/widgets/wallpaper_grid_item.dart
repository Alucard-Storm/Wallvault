...
import 'wallpaper_quick_viewer.dart';
...
class _WallpaperGridItemState extends State<WallpaperGridItem> {
  ...
  void _onLongPress() {
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) => WallpaperQuickViewer(
        ...
        child: AspectRatio(
          ...
          child: Card(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: [
                // Wallpaper image — kept outside Consumer2 so provider
                // rebuilds never recreate the Hero/CachedNetworkImage state.
                RepaintBoundary(
                  child: Hero(
                ...
                // Overlays — only this subtree rebuilds on provider changes.
                Consumer2<FavoritesProvider, DownloadsProvider>(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            // Right padding reserves space for the 40px download button
                            // so the views row never overlaps it.
                        ...
                        // Favorite indicator — positioned separately so it never
                        // overlaps the download button.
                        if (isFavorite)
                          Positioned(
                            bottom: ThemeConfig.spaceSmall,
                            left: ThemeConfig.spaceSmall,
